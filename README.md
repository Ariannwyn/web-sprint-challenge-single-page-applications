...
- End to end testing is the process of testing that begins at the start of the users experience and walks through the entire application to the end where the user exits. 
